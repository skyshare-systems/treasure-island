...
const LandCardMobile = ({ ...props }: ILandCard) => {
  ...
  return (
    <div
      className={cn(
        props.className,
        "relative group/image flex flex-col items-center"
      )}
    >
      <Image
        src={props.image}
      ...
      <div className="flex justify-center items-center opacity-0 scale-75 group-hover/image:scale-100 group-hover/image:opacity-100 ease-out duration-300 max-w-[220px]">
